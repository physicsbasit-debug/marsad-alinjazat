...
function AdminApp(){
  ...
  return <div className="app-shell">
    ...
    <main className="main-area">
      ...
      <section className="workspace">{view==='dashboard'?<Dashboard data={data} onQuickAction={action}/>:view==='teachers'?<Teachers teachers={data.teachers} requests={data.requests} documents={data.documents} onAddTeacher={()=>setTeacherModal(true)} onChanged={refresh}/>:view==='requests'?<Requests requests={data.requests} onNewRequest={()=>setRequestModal(true)} onStatus={changeStatus}/>:view==='events'?<Events events={data.events} onAddEvent={()=>setEventModal(true)}/>:view==='documents'?<Documents documents={data.documents}/>:<Placeholder view={view}/>}</section>
    </main>
