...
function AdminApp(){
  ...
  async function switchAcademicYear(value:string):Promise<boolean>{
    ...
    try{
      ...
      setData(next);setSearchTarget(null);setSupabaseTeacherCount(null);
      return true;
