...
export function Requests({ requests, onNewRequest, onStatus }: { requests: UploadRequest[]; onNewRequest: () => void; onStatus: (id: number, status: RequestStatus) => Promise<void> }) {
